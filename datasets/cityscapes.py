...
class Cityscapes(torch.utils.data.Dataset):
    ...
    def __init__(self, image_path_list,target_path_list, split='train',transforms=None):
        super(Cityscapes, self).__init__()
        self.images = image_path_list
        self.targets = target_path_list
        self.transforms=transforms
        self.classes = {'pedestrian':0,'rider':1,'person group':2,'person (other)':3,'sitting person':4,'ignore':5}
