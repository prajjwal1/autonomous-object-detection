...
class BDD(torch.utils.data.Dataset):
    def __init__(self,img_path,anno_json_path,transforms=None):#total_bboxes_list,total_labels_list,transforms=None):
        ...
        self.classes =  {'bus':0, 'traffic light':1, 'traffic sign':2, 'person':3, 'bike':4, 'truck':5, 'motor':6, 'car':7, 
            'train':8,'rider':9,'drivable area':10,'lane':11}
