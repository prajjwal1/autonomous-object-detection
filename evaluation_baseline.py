...
ds = "IDD"
bdd_path = '/ml/temp/autonue/data/bdd100k/'
batch_size=4
model_name = 's_bdd_t_idd_20000.pth' #'bdd100k_24.pth'
...
model = get_model(15)
#model = get_model(len(val_dataset.classes))
model.to(device)
...
# model.roi_heads.box_predictor = torchvision.models.detection.faster_rcnn.FastRCNNPredictor(model.roi_heads.box_predictor.cls_score.in_features, 15)
# torch.save({
